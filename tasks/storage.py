...
class JSONStorage(Storage):
    ...
    Примичание:
        Использование json в качестве бд полохо
        Причины:
            1 Медленное чтение и запись больших файлов.
            2 Трудности при одновременных запросах.
            3 Сложное структурирование данных при необходимости.
            4 Нет поддержки сложных запросов.
    """
